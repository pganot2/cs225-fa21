...
class Image : public cs225::PNG {
    ...
    /**
      ...
      * For example, if the Image is currently (10, 20) and we want to scale to (100, 100),
      * then this should scale the Image to (50, 100).
      * Note that scaling the image to (100, 200)
      * does not fit within the (100,100) dimensions given and is therefore incorrect.
      * This function both resizes the Image and scales the contents.
