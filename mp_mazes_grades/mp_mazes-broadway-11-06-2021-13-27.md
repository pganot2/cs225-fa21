...
```
tests/test_part2.cpp:45:33: fatal error: no member named 'canTravel' in 'SquareMaze'
...
This report was generated for **pganot2** using **f3e2c2eacebbe515ceeeeb2e1570603ce4a989dd** (latest commit as of **November 6th 2021, 1:27 pm**)
